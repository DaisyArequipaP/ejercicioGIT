...
const songs = [
    ...
    new Song({ id: 16, nombre: "cancion 16", artista: "artista 16", anio: "año 16", duracion: "duracion 16", genero: "genero 16", cover: "./imagenes/cancion15.jpg", urlSong: "./canciones/cancion16.mp3" }),
...
/*probar si esta imprimiendo

songs.forEach(song => {
    console.log(song.getSongid());
});

songs.forEach(song => {
    console.log(song.getSongCover());
});
*/
